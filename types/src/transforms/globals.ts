...
export function maybeExtractGlobalNode(
  ...
  if (
    ...
    // Static methods live on constructors and are not global-scope instance
    // operations. Static properties still represent generated global constants
    // and retain the transform's existing extraction behavior.
